...
// NOTE: When adding new paramters, be very careful to bump your plugin version eg. 1.0.0 > 1.0.1
// DAWs such as Logic Pro will do a better job at registering changes to your paramters when loading project files that
// used previous versions of your plugin. Failing to do this may brake a saved project! Always bump the version!
